...
const mapObjects = {
    ...
    1: [
        ...
        { id: 'fl_spoil',       x: 1110, y: 775,  w: 60,  h: 50,  color: '#5c4a30', label: 'Spoil Mound',        interactScene: 'flavor_spoil_mound'    },
        { id: 'fl_toolshed',    x: 1340, y: 870,  w: 50,  h: 60,  color: '#4a3820', label: "Sam's Tool Shed",    interactScene: 'flavor_tool_shed'      },
        ...
        { id: 'fl_digshed',     x: 900,  y: 870,  w: 50,  h: 60,  color: '#4a3820', label: 'Dig Shed Clipboard', interactScene: 'flavor_digshed'        },
        ...
        deco('d_spoil1',    1095, 765, 80,  50,  '#5c4a30', 'Spoil Mound'     ),
        deco('d_spoil2',    1220, 795, 75,  38,  '#5c4a30', 'Spoil Mound'     ),
        deco('d_spoil3',    1460, 775, 100, 60,  '#5c4a30', 'Spoil Mound'     ),
        deco('d_digshed',   885,  860, 75,  90,  '#4a3820', 'Dig Shed'        ),
        deco('d_toolshed',  1325, 860, 70,  90,  '#4a3820', 'Tool Shed'       ),
